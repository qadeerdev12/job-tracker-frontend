...
export const CHART_COLORS_DARK = ["#3b82f6", "#f59e0b", "#10b981", "#64748b"];

export const inputClass = "w-full border border-input-border bg-input-bg px-4 py-2.5 rounded-lg text-sm text-heading focus:ring-2 focus:ring-brand-500/20 focus:border-brand-400 focus:bg-card outline-none transition-all";

export const PRESET_TAGS = ["Remote", "On-site", "Hybrid", "Frontend", "Backend", "Full Stack", "Graduate", "Contract", "Full-time", "Part-time", "Visa Sponsorship", "Internship"];
